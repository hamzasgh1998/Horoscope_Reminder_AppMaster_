...
public class TaureauHome extends AppCompatActivity {
    ...
    public void rollDice() {
        ...
        switch (number) {
            case 1:
                imageView.setImageResource(R.drawable.toro1);
                break;
            case 2:
                imageView.setImageResource(R.drawable.toro2);
                break;
            case 3:
                imageView.setImageResource(R.drawable.toro3);
                break;
            case 4:
                imageView.setImageResource(R.drawable.toro4);
                break;
            case 5:
                imageView.setImageResource(R.drawable.toro5);
                break;
            default:
