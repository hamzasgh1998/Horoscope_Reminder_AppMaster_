...
public class BalanceHome extends AppCompatActivity {
    ImageView imageView;
    Button button;
    ...
    public void rollDice(){
        ...
        switch (number){
            case 1:
                imageView.setImageResource(R.drawable.balance1);
                break;
            case 2:
                imageView.setImageResource(R.drawable.balance2);
                break;
            case 3:
                imageView.setImageResource(R.drawable.balance3);
                break;
            case 4:
                imageView.setImageResource(R.drawable.balance4);
                break;
            case 5:
                imageView.setImageResource(R.drawable.balance5);
                break;
            default:
