...
public class PoissonHome extends AppCompatActivity {
    ...
    public void rollDice() {
        ...
        switch (number) {
            case 1:
                imageView.setImageResource(R.drawable.poisson1);
                break;
            case 2:
                imageView.setImageResource(R.drawable.poisson2);
                break;
            case 3:
                imageView.setImageResource(R.drawable.poisson3);
                break;
            case 4:
                imageView.setImageResource(R.drawable.poisson4);
                break;
            case 5:
                imageView.setImageResource(R.drawable.poisson5);
                break;
            default:
